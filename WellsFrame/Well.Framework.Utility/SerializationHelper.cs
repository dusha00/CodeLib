...
namespace Well.Framework.Utility
{
    ...
    public class SerializationHelper
    {
        ...
        public static string DataContractSerialize(object o)
        {
            ...
            string ret = Encoding.UTF8.GetString(stream.ToArray());
            return ret;
        }
        ...
        public static object DataContractDeserialize(Type type, string xmlStr)
        {
            ...
            MemoryStream stream = new MemoryStream(Encoding.UTF8.GetBytes(xmlStr));//new StringReader(xmlStr);
